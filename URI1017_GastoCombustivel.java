...
a mesma (em km/h). Assim, pode-se obter distância percorrida e, em seguida, calcular quantos litros
...
public class URI1017_GastoCombustivel {
    public static void main(String[] args) {
        ...
        int distancia = km*horas;
        BigDecimal combustivel = new BigDecimal(distancia/12.0);
        combustivel = combustivel.setScale(3, RoundingMode.HALF_EVEN);
